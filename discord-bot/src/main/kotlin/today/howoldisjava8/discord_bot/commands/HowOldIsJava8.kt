...
import today.howoldisjava8.discord_bot.core.sendNotice
...
fun howOldIsJava8() = command("howoldisjava8") {
  invoke(BooleanArgument.named("use-tts").withDefault(false)) { useTTS ->
...
object HowOldIsJava8SlashCommand {
  ...
  private suspend fun registerCommand(kord: Kord) {
    // Global commands have a 2 hour update time so for testing you may want to use guild commands as they update instantly
